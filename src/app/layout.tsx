...
export const metadata: Metadata = {
  ...
  // Generated by scripts/build-app-icon.mjs — mango tile, ink keyline, ink
  // dachshund. The .ico is listed first and carries 16/32/48, which is what
  // a browser tab actually reaches for; icon.svg is offered alongside it for
  // anything that prefers vector.
  icons: {
    icon: [
...
export const viewport: Viewport = {
  // Ink. Was #3a2317, the retired warm palette's ink.
  themeColor: "#1E1712",
  width: "device-width",
  initialScale: 1,
};
